        ...
        <div class="col-8 offset-4 offset-small-0 small-12">
            ...
            <label for="activities" class="row middle">
                ...
                <select class="col-7" name="activities" id="activities">
                    ...
                    <option value="audiovisual" {{(old('activities')=='audiovisual')?'selected':''}}>Audiovisual
                    </option>
                    <option value="diseno" {{(old('activities')=='diseno')?'selected':''}}>Diseño</option>
                    <option value="musica" {{(old('activities')=='musica')?'selected':''}}>Música</option>
                    <option value="editorial" {{(old('activities')=='editorial')?'selected':''}}>Editorial</option>
                    <option value="animacion_videojuegos" {{(old('activities')=='animacion_videojuegos')?'selected':''}}>
                        Animación y Videojuegos
                    </option>
                    <option value="artes_escenicas" {{(old('activities')=='artes_escenicas')?'selected':''}}>Artes
                        escénicas
                    </option>
                </select>
            </label>
